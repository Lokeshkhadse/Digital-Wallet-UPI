...
public class GlobalException {
    ...
    public ResponseEntity<Map<String,Object>> BeneficiaryAlreadyExists(
            BeneficiaryAlreadyExistsException ex){
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(Map.of(
                        "timestamp", LocalDateTime.now(),
                        "status", 400,
                        "error", "Beneficary Already Exist",
                        "message", ex.getMessage()
                ));
    ...
    public ResponseEntity<Map<String, Object>> dailyLimitExceededException(
    ...
    @ExceptionHandler(
            ScheduledTransferNotFoundException.class)
    public ResponseEntity<Map<String,Object>>
    scheduledTransferNotFoundException(
            ScheduledTransferNotFoundException ex){
    ...
    @ExceptionHandler(
            BecauseRetryCountException.class)
    public ResponseEntity<Map<String,Object>>
    becauseRetryCountException(
            BecauseRetryCountException ex){
    ...
    public ResponseEntity<Map<String, Object>> handlePinLockedException(
        ...
        return ResponseEntity.status(423)
                .body(Map.of(
                        "timestamp", LocalDateTime.now(),
                        "status",423,
                        "error","multiple attempt , pin locked",
                        "message",ex.getMessage()
                ));
    }
